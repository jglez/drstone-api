  ...
  return (
    <div id="about-page">
      <div id="about-container">
        ...
        <p>In Dr. Stone, the protagonist, Senku, finds himself in a primitive world where modern technology and civilization has decayed after waking up 3,700 years after all humans were petrified in stone. <br /><br />Using his love for problem-solving and science, Senku re-creates humanity's inventions from the ground-up to help a group of villagers he finds, struggling with issues such as illness due to pathogens. &#40;There's even an arc where Senku re-creates antibiotics using nothing but primitive tools in order to save someone!&#41; <br /><br /> Watching the show, Senku's passion for science and creating things reminded me of myself when I was really curious as a kid too, so I felt inspired and decided to build this in his honor!</p>
