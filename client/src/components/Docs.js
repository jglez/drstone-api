  ...
  return(
    <div id="docs-page">
      <div id="docs-container">
        <h2>Resources</h2>
        <p>The Dr. Stone API has two resources: <a target="_blank" rel="noreferrer" href="https://drstone-api.herokuapp.com/api/characters">characters</a> and <a target="_blank" rel="noreferrer" href="https://drstone-api.herokuapp.com/api/episodes">episodes</a>. Of the two, characters is the more interesting one as it has a lot more data including an image for each character.</p>

        <h2>REST</h2>
        <p>Base URL: <a target="_blank" rel="noreferrer" href="https://drstone-api.herokuapp.com/api">https://drstone-api.herokuapp.com/api</a></p>
